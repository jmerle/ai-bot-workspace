      ...
      const page = `
        ...
        <html lang="en">
          <head>
            ...
            <title>AI Block Battle Match Viewer</title>

            <link rel="stylesheet" href="../../css/font-awesome.min.css">
            <link rel="stylesheet" href="css/v3.min.css">
            <link rel="stylesheet" href="css/v3-override.min.css">
          </head>
          <body>
            ...
            <script src="js/v3.min.js"></script>
          </body>
        </html>
      `;
